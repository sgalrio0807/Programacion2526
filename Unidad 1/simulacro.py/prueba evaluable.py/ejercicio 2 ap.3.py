...
numveces= 1
victoriasapostador= 0
while suma_total != apostador:
    victoriasapostador + numveces
print("El apostador ganó",victoriasapostador + numveces, "veces.")
    
victoriasmaquina= 0
while suma_total == apostador:
    victoriasmaquina + numveces
print("La máquina ganó",victoriasmaquina + numveces, "veces.")
